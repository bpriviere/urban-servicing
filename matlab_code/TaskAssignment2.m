function agents = TaskAssignment2(param, agents, requests)
    ...
    while any(same_action_count < param.task_convergence)
        ...
        J = calcJ(param, agents, requests, i, agents(i).curr_action_i);
        J_p = calcJ(param, agents, requests, i, agents(i).prop_action_i); 
