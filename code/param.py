...
class Param:
	def __init__(self):
		...
		self.plot_agent_mode_color = ['blue','green','orange','blue'] # idle, pickup, dropoff, on dispatch
		...
		if self.env_name is 'gridworld':
			...
			self.cm_ng = 1
			self.cm_sigma = self.env_dx*0.001
			self.cm_speed = 0.25 # dist/time 
